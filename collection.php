...
<body class="px-4 sm:px-[5vw] md:px-[7vw] lg:px-[9vw]">
  ...
  <div class="max-w-7xl mx-auto px-4 py-12 grid grid-cols-1 md:grid-cols-4 gap-8">
    ...
    <main class="md:col-span-3">
      ...
      <!-- Desktop Top Bar -->
      <div id="mainDiv" class="hidden md:flex md:items-center md:justify-between mb-6 gap-4 bg-white p-4 rounded-lg shadow">
      ...
      <!-- Mobile Top Bar -->
      <div id="mobileTop" class="md:hidden mb-6 bg-white p-4 rounded-lg shadow flex justify-between gap-4">
        <h1 class="w-full text-xl font-bold">ALL COLLECTION</h1>

        <div class="flex w-full justify-between">
          
        <select id="mobileSortSelect" class="w-full border border-gray-300 p-2 rounded focus:outline-none focus:ring-2 focus:ring-green-600">
          <option value="">Sort By:</option>
          <option value="priceLow">Price: Low to High</option>
          <option value="priceHigh">Price: High to Low</option>
          <option value="nameAsc">Name: A-Z</option>
        ...
        <div class="flex w-full items-center px-4 border-2 mx-4"> 
          <!-- Toggle button --><div class="relative inline-block">
  <button id="toggleFilters" class="px-2">
    Filters <span id="filterArrow">▼</span>
  </button>

  <div id="mobileFilters" class="hidden absolute left-0 top-10 mt-2 p-4 rounded bg-white shadow flex flex-col gap-2 z-50">
    <!-- JS inject checkboxes -->
  </div>
</div>
      ...
      <!-- Products Grid -->
      <div id="productsGrid" class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div class="product-card bg-white p-4 rounded-lg shadow hover:shadow-lg transition" data-category="balm" data-price="200" data-name="Hari Ganga Balm">
        ...
        <div class="product-card bg-white p-4 rounded-lg shadow hover:shadow-lg transition" data-category="tea" data-price="200" data-name="Samahan Herbal Tea">
        ...
        <div class="product-card bg-white p-4 rounded-lg shadow hover:shadow-lg transition" data-category="paste" data-price="110" data-name="Nidco Shilajit Paste">
...
toggleBtn.addEventListener("click", () => {
  mobileFilters.classList.toggle("hidden"); // Show/hide the div
  filterArrow.textContent = mobileFilters.classList.contains("hidden") ? "▼" : "▲";
    ...
    function filterProducts() {
      ...
      productCards.forEach(card => {
        if(selected.length === 0 || selected.includes(card.dataset.category)){
