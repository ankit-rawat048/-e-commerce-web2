        ...
        <div class="flex-1 p-4 md:p-6">
            ...
            <div class="mt-10">
                <div class="flex flex-col sm:flex-row w-full items-start sm:items-center mb-4 gap-4">
                    ...
                    <div
                        class="flex w-full justify-between items-stretch sm:items-center bg-gray-100 p-2 rounded-lg shadow-sm gap-2">
                        ...
                        <input type="text" id="searchInput" placeholder="Search by ID or Name"
                            class="border border-gray-400 focus:border-green-500 focus:ring-1 focus:ring-green-400 rounded-lg px-3 py-2 text-sm outline-none transition" />
                    </div>
                </div>

                <div class="table-size overflow-y-auto overflow-x-auto max-h-[450px] bg-white rounded-lg shadow-lg">
                    <table class="w-full md:min-w-[700px] lg:min-w-[900px] divide-y divide-gray-200" id="productTable">
    ...
    <div id="addModal" class="modal">
        <div class="bg-white rounded-xl shadow-2xl p-8 w-full max-w-md relative">
            ...
            <form id="addProductForm" class="space-y-4">
                ...
                <div>
                    <label for="addDescription" class="block text-sm font-medium text-gray-700 mb-1">About
                        Product</label>
                    <textarea id="addDescription" name="description" rows="3" placeholder="Short product description..."
            ...
            <form id="editProductForm" class="space-y-4">
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <input id="editPrice" type="number" step="0.01" name="price"
                            class="w-full border rounded-lg p-3" required>
                    </div>
                    <div>
                ...
                <div>
                    <label for="editDescription" class="block text-sm font-medium text-gray-700 mb-1">About
                        Product</label>
                ...
                <div>
                    ...
                    <input id="editImageUrl" type="text" name="imageUrl" class="w-full border rounded-lg p-3"
