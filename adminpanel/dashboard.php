                        ...
                        <tbody class="divide-y divide-gray-200 text-sm">
                            ...
                            <tr class="hover:bg-gray-100 even:bg-gray-50 transition"
                                ...
                                <td class="py-3 px-4">
                                    <select class="status-select px-3 py-1 rounded-full text-xs font-medium border">
                                        ...
                                        <option value="Cancelled" <?=$o['status']=="Cancelled" ? "selected" : "" ?>
                                            >Cancelled</option>
                                        <option value="In-Progress" <?=$o['status']=="In-Progress" ? "selected" : "" ?>
                                            >In-Progress</option>
                                    </select>
                                </td>
                                <td class="py-3 px-4 flex gap-2">
                                    ...
                                    <button
                                        onclick="openBillModal('<?= $o['customer'] ?>','<?= $o['product'] ?>','<?= $o['quantity'] ?>','<?= $o['date'] ?>','<?= $o['status'] ?>')"
    ...
    <script>
        ...
        document.getElementById("searchInput").addEventListener("input", function () {
            ...
            document.querySelectorAll("tbody tr").forEach(row => {
                ...
                row.style.display = (name.includes(query) || product.includes(query)) ? "" : "none";
            });
        });
    </script>
